...
/* 					
	...
	function num2decimal(num){
		return parseFloat(Math.round(num * 100) / 100).toFixed(2);
			...
			//console.log(CartBundleObj);
			$(document).on('click', '#BundleAddBtn', function(){
				jQuery("#BundleAddBtn").after('<br><div style="text-align:center;font-size:12px;"><img src="https://checkoutbundles.com/scripts/spinner.gif" width="40" /><br>Redirecting</div>');
				var rqD = $("#bundleprods").val();	
				var items_to_add = JSON.parse(rqD);
				var TotBundlePrice = 0;
				var OfferId = 0
